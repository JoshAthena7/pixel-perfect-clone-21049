...
const CATEGORY_META: Record<Category, { title: string; subtitle: string; placeholder: string; sendLabel: string; toastText: string; icon: React.ReactNode; accent: string }> = {
  it: {
    ...
    sendLabel: "Send to IT Team",
    toastText: "IT team has been notified. They'll respond shortly.",
  ...
  billing: {
    ...
    sendLabel: "Send to Finance",
    toastText: "Finance team has been notified.",
  ...
  platform: {
    ...
    sendLabel: "Contact Support Team",
    toastText: "Support team has been notified.",
