        ...
        <div className="flex items-center gap-2">
          {canRegenerate && (
            <button
              ...
              className="inline-flex items-center gap-1 rounded border border-border/40 px-2 py-0.5 text-[11px] text-muted-foreground hover:text-foreground hover:border-border disabled:opacity-50"
        ...
        <>
          ...
          {insight.tags && insight.tags.length > 0 && (
            <div className="mt-3 flex flex-wrap gap-1">
              {insight.tags.map((t) => (
                <span key={t} className="rounded-sm bg-white/5 px-1.5 py-0.5 text-[11px] text-muted-foreground">{t}</span>
              ))}
            </div>
          )}
        </>
