    ...
    <div className="rounded-lg border border-white/10 bg-white/[0.02] overflow-hidden">
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="text-xs text-white/45 truncate">{category.shortDescription}</div>
        </div>
      ...
      {open && (
        <div className="border-t border-white/5 px-4 py-3 space-y-3">
          <div className="text-[11px] text-white/55">
            <span className="font-semibold text-white/70">Examples to upload:</span>
          ...
          {current.length > 0 && (
            <ul className="space-y-1">
              {current.map((d) => (
                <li key={d.id} className="flex items-center gap-2 text-sm bg-white/[0.02] rounded px-3 py-2">
                  <div className="flex-1 min-w-0">
