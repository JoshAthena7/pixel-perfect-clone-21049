          ...
          return (
            <div key={s.key as string} className="px-5 py-3.5">
              ...
              >
                ...
                <span className="text-[13px] font-medium text-white flex-1">{s.label}</span>
                {isEmpty && (
                  ...
                  {isEditing ? (
                    <div className="space-y-2">
                      <textarea
                        ...
                        className="w-full bg-white/5 border border-white/15 rounded px-3 py-2 text-[13px] text-white focus:outline-none focus:border-amber-400/60"
                    ...
                    <p className="text-[13px] text-white/85 whitespace-pre-wrap">
                      {(value as string) ||
                        "No intelligence on file — add via the button above."}
                    </p>
                  )}
      ...
      >
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-2">
            ...
            <h4 className="text-[13px] font-semibold tracking-wide" style={{ color: "#fde68a" }}>
