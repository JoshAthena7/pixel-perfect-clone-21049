...
import { ArrowLeft, Brain, FileText, ListChecks, LayoutGrid, Sliders, ShieldCheck, Check, Archive, Users, UserCircle2 } from "lucide-react";
...
import MissionTeam from "@/components/olympus/MissionTeam";

type Tab = "assignments" | "team" | "overview" | "sections" | "intelligence" | "requirements" | "setup" | "oversight" | "closeout";

export const Route = createFileRoute("/_authenticated/admin/missions/$missionId")({
  validateSearch: (s: Record<string, unknown>): { tab?: Tab } => {
    const t = s.tab;
    if (t === "assignments" || t === "team" || t === "overview" || t === "sections" || t === "intelligence" || t === "requirements" || t === "setup" || t === "oversight" || t === "closeout") return { tab: t };
    return {};
  },
    ...
    <div className="flex-1 min-w-0">
      ...
      <div className="border-b border-border bg-surface/20 px-5">
        <nav className="flex gap-1 overflow-x-auto">
          ...
          <TabBtn active={tab === "team"} onClick={() => setTab("team")} icon={<UserCircle2 className="h-3.5 w-3.5" />}>Team</TabBtn>
      ...
      <div className="p-5">
        ...
        {tab === "team" && <MissionTeam missionId={missionId} />}
...
/* ─── Closeout ─── */
const CLOSEOUT_ITEMS: { key: string; label: string; desc: string }[] = [
  { key: "access_removed", label: "Client Access Removed", desc: "All team member access to client systems has been removed" },
  { key: "invoices_submitted", label: "Final Invoices Submitted", desc: "All final invoices have been submitted and acknowledged" },
  { key: "contracts_closed", label: "Contracts Closed", desc: "All contracts have been formally closed" },
  { key: "docs_archived", label: "Documents Archived", desc: "All mission documents archived to final storage" },
  { key: "lessons_documented", label: "Lessons Learned Documented", desc: "Lessons learned have been written and saved below" },
  { key: "feedback_collected", label: "Team Feedback Collected", desc: "Feedback collected from all team members" },
];
