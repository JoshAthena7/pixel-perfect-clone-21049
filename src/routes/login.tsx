    ...
    <div className="relative min-h-screen w-full overflow-hidden bg-[#040814] text-white">
      ...
      <div className="relative z-10 mx-auto h-screen w-full">
        <div className="relative mx-auto h-full" style={{ aspectRatio: "1536 / 1024", maxWidth: "min(100vw, calc(100vh * 1536 / 1024))" }}>
          {/* Interactive form overlay — coordinates match the panel in the graphic */}
          <form
            onSubmit={onSubmit}
            className="absolute"
            style={{ left: "35%", right: "35%", top: "43%", bottom: "27%" }}
          >
            <div className="flex h-full w-full flex-col justify-center gap-4 px-6">
              {/* Email */}
              <label className="block">
                <span className="mb-1 block text-[11px] font-medium text-white/80">Email</span>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-md border border-amber-500/20 bg-[#0a1428]/80 py-2.5 pl-10 pr-3 text-sm text-white placeholder:text-white/35 backdrop-blur-sm transition focus:border-amber-400/60 focus:outline-none focus:ring-1 focus:ring-amber-400/40"
                  />
                </div>
              </label>
              ...
              {/* Password */}
              <label className="block">
                <span className="mb-1 block text-[11px] font-medium text-white/80">Password</span>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-md border border-amber-500/20 bg-[#0a1428]/80 py-2.5 pl-10 pr-10 text-sm text-white placeholder:text-white/35 backdrop-blur-sm transition focus:border-amber-400/60 focus:outline-none focus:ring-1 focus:ring-amber-400/40"
                  />
                  <button
                    type="button"
              ...
              <button
                type="submit"
                disabled={loading}
                className="group mt-2 flex w-full items-center justify-center gap-2 rounded-md bg-gradient-to-b from-amber-300 via-amber-400 to-amber-600 py-3 text-sm font-semibold uppercase tracking-[0.25em] text-[#1a1206] shadow-[0_8px_24px_-8px_rgba(245,158,11,0.55)] transition hover:from-amber-200 hover:to-amber-500 disabled:opacity-60"
              >
